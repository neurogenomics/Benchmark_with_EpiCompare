...
H3K9me1_200_control <- ChIPseeker::readPeakFile("/Users/apple/Downloads/cutandrun/called_peaks/H3K9me1_200_dedup_control.peaks.stringent.bed", as = "GRanges")
H3K9me1_200_top001 <- ChIPseeker::readPeakFile("/Users/apple/Downloads/cutandrun/called_peaks/H3K9me1_200_dedup_top001.peaks.stringent.bed", as = "GRanges")

H3K9me1_ENCODE <- ChIPseeker::readPeakFile("/Users/apple/Downloads/cutandrun/ENCODE_ref/H3K9me1_ENCFF285EKW.bed", as = "GRanges")

peaklist <- list(H3K9me1_200_control, H3K9me1_200_top001)
names(peaklist) <- c("H3K9me1_200_control", "H3K9me1_200_top001") 

ENCODE <- list("H3K9me1_ENCODE" = H3K9me1_ENCODE)
